...
def exercise_3():
    ...
    # and store the results of those function calls (in other words, how many throws it took until doubles were thrown, each time) 
    # in a collection. 
    ...
    def main():
        throw_list = []
        for i in range(100):
            i = throw_until_doubles()
            throw_list.append(i)
        
        total_throws = sum(throw_list)
        print(f"Total throws: {total_throws}")
        print(f"Average throws to reach doubles {total_throws/len(throw_list)}")
