...
SELECT film_id, title, description, length, rental_rate FROM film WHERE title ILIKE '%_Jedi'
*/
...
SELECT film_id, title, description, length, rental_rate FROM film WHERE title ILIKE 'Al_%'
*/
...
SELECT * FROM film ORDER BY replacement_cost ASC FETCH FIRST 10 ROWS ONLY OFFSET 10
*/
